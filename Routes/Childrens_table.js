...
Router.post("/Insert", (req, res) => {
  ...
  console.log(Details);
  Result("Childrens_table", "Insert", Details)
    .then((result) => {
      res.send(result);
      console.log(result);
    })
...
Router.delete("/Delete:ID", (req, res) => {
  ...
  Result("Childrens_table", "Delete", Details)
    .then((result) => {
      res.send(result);
      console.log(result);
    })
...
Router.put("/Update:ID", (req, res) => {
  ...
  console.log(Details);
  Result("Childrens_table", "Update", Details, UpdatedDetails)
    .then((result) => {
      res.send(result);
      console.log(result);
    })
...
Router.get("/Read:_ID", (req, res) => {
  ...
  Result("Childrens_table", "Read", Details)
    .then((result) => {
