...
Router.post("/Insert", (req, res) => {
  ...
  console.log(Details);
  Result("Staff_table", "Insert", Details)
    .then((result) => {
      res.send(result);
      console.log(result);
    })
...
Router.delete("/Delete:ID", (req, res) => {
  ...
  Result("Staff_table", "Delete", Details)
    .then((result) => {
      res.send(result);
      console.log(result);
    })
...
Router.put("/Update:ID", (req, res) => {
  ...
  console.log(Details);
  Result("Staff_table", "Update", Details, UpdatedDetails)
    .then((result) => {
      res.send(result);
      console.log(result);
    })
...
Router.get("/Read:_ID", (req, res) => {
  ...
  Result("Staff_table", "Read", Details)
    .then((result) => {
...
Router.get("/login:_ID", (req, res) => {
  const Details = req.params._ID;
  Result("Staff_table", "login", Details)
    .then((result) => {
      res.send({ Message: result.Message, Result: result.rows });
      console.log(result);
    })
