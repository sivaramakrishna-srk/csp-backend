...
Router.post("/Insert", (req, res) => {
  ...
  console.log(Details);
  Result("Mothers_table", "Insert", Details)
    .then((result) => {
      res.send(result);
      console.log(result);
    })
...
Router.delete("/Delete:ID", (req, res) => {
  ...
  Result("Mothers_table", "Delete", Details)
    .then((result) => {
      res.send(result);
      console.log(result);
    })
...
Router.put("/Update:ID", (req, res) => {
  ...
  console.log(Details);
  Result("Mothers_table", "Update", Details, UpdatedDetails)
    .then((result) => {
      res.send(result);
      console.log(result);
    })
...
Router.get("/Read:_ID", (req, res) => {
  ...
  Result("Mothers_table", "Read", Details)
    .then((result) => {
